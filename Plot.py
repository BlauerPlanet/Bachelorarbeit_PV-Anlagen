...
#                print(KP.loc[f"{ind}"])
            ...
            plt.boxplot(KAM, labels="M", showmeans=True, meanprops={"marker":"+"})
            ax2=plt.subplot(1,3,2, sharey=ax1)
            plt.tick_params("y", labelleft=False)
            plt.boxplot(KAH, labels="H", showmeans=True, meanprops={"marker":"+"})
            ax3=plt.subplot(1,3,3, sharey=ax1)
            plt.tick_params("y", labelleft=False)
            plt.boxplot(KAS, labels="S", showmeans=True, meanprops={"marker":"+"})
#            plt.show()
            plt.savefig(rf"Figures\Kopfdaten\{selection}\{i}.png", bbox_inches="tight")
            plt.close()
...
#                print(KP.loc[f"{ind}"])
            ...
            plt.boxplot(KMA, labels="M", showmeans=True, meanprops={"marker":"+"})
            ax2=plt.subplot(1,2,2, sharey=ax1)
            plt.tick_params("y", labelleft=False)
            plt.boxplot(KBE, labels="B", showmeans=True, meanprops={"marker":"+"})
#            plt.show()
            plt.savefig(rf"Figures\Kopfdaten\{selection}\{i}.png", bbox_inches="tight")
            plt.close()
...
#                print(KP.loc[f"{ind}"])
            ...
            pd.DataFrame(data=[KBEMdata,KBEHdata,KBESdata,KMAMdata,KMAHdata,KMASdata], index=["B-M","B-H","B-S","M-M","M-H","M-S"], columns=["Parameter","n","mean","median","std","KW","p","M-H","M-S","H-S", "","MB-MM","HB-HM","SB-SM"]).to_excel(f"XLSX\{selection}\{i}.xlsx")
            ...
            plt.boxplot(KMAM, labels="M", showmeans=True, meanprops={"marker":"+"})
            ax2=plt.subplot(1,7,2, sharey=ax1)
            plt.tick_params("y", labelleft=False)
            plt.boxplot(KMAH, labels="H", showmeans=True, meanprops={"marker":"+"})
            ax3=plt.subplot(1,7,3, sharey=ax1)
            plt.tick_params("y", labelleft=False)
            plt.boxplot(KMAS, labels="S", showmeans=True, meanprops={"marker":"+"})
            ax4=plt.subplot(1,7,5, sharey=ax1)
            plt.title(f"{i} - Beweidung", loc="left")
            plt.tick_params("y", labelleft=True)
            plt.boxplot(KBEM, labels="M", showmeans=True, meanprops={"marker":"+"})
            ax5=plt.subplot(1,7,6, sharey=ax1)
            plt.tick_params("y", labelleft=False)
            plt.boxplot(KBEH, labels="H", showmeans=True, meanprops={"marker":"+"})
            ax6=plt.subplot(1,7,7, sharey=ax1)
            plt.tick_params("y", labelleft=False)
            plt.boxplot(KBES, labels="S", showmeans=True, meanprops={"marker":"+"})
#            plt.show()
            plt.savefig(rf"Figures\Kopfdaten\{selection}\{i}.png", bbox_inches="tight")
            plt.close()
